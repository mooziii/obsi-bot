...
public data class Event(
  ...
  public val eventType: Event.EventType,
  /**
   * The event's name
   */
   ...
   */
  public val server: Event.Server,
  /**
   * The event's main language
   */
  public val language: String,
  public val departure: Event.Departure,
  public val arrive: Event.Arrive,
  /**
   ...
   */
  public val vtc: Event.Vtc? = null,
  public val user: Event.User,
  public val attendances: Event.Attendances,
  /**
   * The event's required DLCs
   */
  public val dlcs: Event.Dlcs,
  /**
   * URL to the event
   */
  ...
  public data class Attendances(
    ...
    /**
     * The array of confirmed attendees
     */
    @SerialName("confirmed_users")
    public val confirmedUsers: List<EventUser>,
    /**
     * The array of unsure attendees
     */
    @SerialName("unsure_users")
    public val unsureUsers: List<EventUser>,
  )
